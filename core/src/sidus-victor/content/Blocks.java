...
import sidus-victor.entities.bullet.*;
import sidus-victor.gen.*;
import sidus-victor.graphics.*;
import sidus-victor.type.*;
import sidus-victor.world.*;
import sidus-victor.world.blocks.*;
import sidus-victor.world.blocks.campaign.*;
import sidus-victor.world.blocks.defense.*;
import sidus-victor.world.blocks.defense.turrets.*;
import sidus-victor.world.blocks.distribution.*;
import sidus-victor.world.blocks.environment.*;
import sidus-victor.world.blocks.legacy.*;
import sidus-victor.world.blocks.liquid.*;
import sidus-victor.world.blocks.logic.*;
import sidus-victor.world.blocks.payloads.*;
import sidus-victor.world.blocks.power.*;
import sidus-victor.world.blocks.production.*;
import sidus-victor.world.blocks.sandbox.*;
import sidus-victor.world.blocks.storage.*;
import sidus-victor.world.blocks.units.*;
import sidus-victor.world.consumers.*;
import sidus-victor.world.draw.*;
import sidus-victor.world.meta.*;

import static sidus-victor.type.ItemStack.*;
