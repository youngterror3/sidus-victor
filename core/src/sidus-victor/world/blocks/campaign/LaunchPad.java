package sidus-victor.world.blocks.campaign;
...
public class LaunchPad extends Block{
    ...
    static abstract class LaunchPayloadComp implements Drawc, Timedc, Teamc{
        ...
        public void draw(){
            ...
            TextureRegion region = blockOn() instanceof sidus-victor.world.blocks.campaign.LaunchPad p ? p.podRegion : Core.atlas.find("launchpod");
