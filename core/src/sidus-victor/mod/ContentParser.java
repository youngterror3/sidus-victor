    ...
    private String makeError(Throwable t, Fi file){
        ...
        if(t.getMessage() != null && t instanceof JsonParseException){
            ...
            for(Throwable e : causes){
                ...
                e.getMessage().replace("sidus-victor.", "").replace("arc.", "") : "").append("\n");
            }
        }
