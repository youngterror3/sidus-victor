...
public class ModsDialog extends BaseDialog{
    ...
    void getModList(Cons<Seq<ModListing>> listener){
        if(modList == null){
            Http.get("https://raw.githubusercontent.com/Anuken/sidus-victorMods/master/mods.json", response -> {
                    ...
                    con.add(new BorderImage(){
                        ...
                        public void draw(){
                            ...
                            if(!textureCache.containsKey(repo)){
                                ...
                                Http.get("https://raw.githubusercontent.com/Anuken/sidus-victorMods/master/icons/" + repo.replace("/", "_"), res -> {
