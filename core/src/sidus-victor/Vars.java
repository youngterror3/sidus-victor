...
import sidus-victor.async.*;
import sidus-victor.core.*;
import sidus-victor.ctype.*;
import sidus-victor.editor.*;
...
public class Vars implements Loadable{
    ...
    public static final String appName = "sidus-victor";
    /** Github API URL. */
    public static final String ghApi = "https://api.github.com";
    /** URL for discord invite. */
    public static final String discordURL = "https://discord.gg/sidus-victor";
    /** URL for sending crash reports to. Currently offline. */
    public static final String crashReportURL = "http://192.99.169.18/report";
    /** URL the links to the wiki's modding guide.*/
    public static final String modGuideURL = "https://sidus-victorgame.github.io/wiki/modding/1-modding/";
    /** URL to the JSON file containing all the BE servers. Only queried in BE. */
    public static final String serverJsonBeURL = "https://raw.githubusercontent.com/Anuken/sidus-victor/master/servers_be.json";
    /** URL to the JSON file containing all the stable servers.  */
    //TODO merge with v6 list upon release
    public static final String serverJsonURL = "https://raw.githubusercontent.com/Anuken/sidus-victor/master/servers_v7.json";
    /** URL of the github issue report template.*/
    public static final String reportIssueURL = "https://github.com/Anuken/sidus-victor/issues/new?labels=bug&template=bug_report.md";
