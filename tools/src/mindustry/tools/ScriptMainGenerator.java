...
public class ScriptMainGenerator{
    ...
    public static void main(String[] args) throws Exception{
        ...
        "sidus-victor.entities.effect",
        "sidus-victor.entities.bullet",
        "sidus-victor.entities.abilities",
        "sidus-victor.ai.types",
        "sidus-victor.type.weather",
        "sidus-victor.type.weapons",
        "sidus-victor.type.ammo",
        "sidus-victor.game.Objectives",
        "sidus-victor.world.blocks",
        "sidus-victor.world.draw",
        "sidus-victor.type"
        );

        String classTemplate = "package sidus-victor.mod;\n" +
        "\n" +
        "import arc.struct.*;\n" +
        ...
        new Fi("core/src/sidus-victor/mod/ClassMap.java").writeString(classTemplate.replace("$CLASSES$", cdef.toString()));
    ...
    public static Seq<Class> findClasses(File directory, String packageName) throws Exception{
        ...
        if(dir.startsWith("file:")){
            directory = new File(dir.substring("file:".length()).replace("!/arc", "").replace("!/sidus-victor", ""));
        }
