...
@SupportedAnnotationTypes("sidus-victor.annotations.Annotations.Load")
public class LoadRegionProcessor extends BaseProcessor{
    ...
    public void process(RoundEnvironment env) throws Exception{
        ...
        MethodSpec.Builder method = MethodSpec.methodBuilder("loadRegions")
            .addParameter(tname("sidus-victor.ctype.MappableContent"), "content")
    ...
    private String parse(String value){
        value = '"' + value + '"';
        value = value.replace("@size", "\" + ((sidus-victor.world.Block)content).size + \"");
