package sidus-victor.annotations.misc;
...
@SupportedAnnotationTypes("sidus-victor.annotations.Annotations.RegisterStatement")
public class LogicStatementProcessor extends BaseProcessor{
    ...
    public void process(RoundEnvironment env) throws Exception{
        ...
        MethodSpec.Builder reader = MethodSpec.methodBuilder("read")
            .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
            .returns(tname("sidus-victor.logic.LStatement"))
        ...
        type.addField(FieldSpec.builder(
            ...
            ParameterizedTypeName.get(ClassName.get(Prov.class),
                tname("sidus-victor.logic.LStatement"))), "allStatements", Modifier.PUBLIC, Modifier.STATIC)
